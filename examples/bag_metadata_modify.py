...
logging.debug(bag_0)
logging.debug(type(bag_0.elevation(mask_nan=True)))
logging.debug(bag_0.elevation(mask_nan=True).shape)
logging.debug(bag_0.elevation(mask_nan=True).dtype)
